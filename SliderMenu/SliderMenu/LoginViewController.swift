...
//                    var centNav = self.storyboard?.instantiateViewControllerWithIdentifier("navView") as! UINavigationController
                    var centView = self.storyboard?.instantiateViewControllerWithIdentifier("ViewController") as! ViewController
                    var navController = UINavigationController(rootViewController: centView)
